...
if(isNil {LV_fnc_removeGroupv2}) then {LV_fnc_removeGroupv2 = compileFinal preProcessFileLineNumbers "\x\addons\Sector_addon\scripts\LV\LV_functions\LV_fnc_removeGroupv2.sqf";};
if(isNil {NP_fnc_isPlayernear}) then {NP_fnc_isPlayernear = compileFinal preProcessFileLineNumbers "\x\addons\Sector_addon\scripts\LV\LV_functions\NP_fnc_isPlayernear.sqf";};
if(isNil {LV_militarize}) then {LV_militarize = compileFinal preProcessFileLineNumbers "\x\addons\Sector_addon\scripts\LV\militarize.sqf";};
if(isNil {LV_fillHouse}) then {LV_fillHouse = compileFinal preProcessFileLineNumbers "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";};
