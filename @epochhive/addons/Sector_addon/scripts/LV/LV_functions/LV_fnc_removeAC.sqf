...
LV_deleteOnDestination = compile preprocessFile "\x\addons\Sector_addon\scripts\LV\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "\x\addons\Sector_addon\scripts\LV\LV_functions\LV_fnc_killAfterDelay.sqf";
