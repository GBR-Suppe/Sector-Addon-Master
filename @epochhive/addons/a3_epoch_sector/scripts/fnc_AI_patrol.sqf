...
*/
	...
	if(isNil("fnc_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "\x\addons\a3_epoch_sector\scripts\fnc_closeDoors.sqf";};
	if(isNil("fnc_nearestBuilding"))then{LV_nearestBuilding = compile preprocessFile "\x\addons\a3_epoch_sector\scripts\fnc_nearestBuilding.sqf";};
