/*
	File: 		Sector_addon init special for Taviana
	Author: 	GBR Suppe
	Update: 	05.05.2015
	Version: 	0.0.1c
...
nul = ["sec1",3,true,2,[4,1],500,"default",nil,nil,1] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec2",3,true,2,[4,1],500,"default",nil,nil,2] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec3",3,true,2,[4,1],500,"default",nil,nil,3] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec4",3,true,2,[4,1],500,"default",nil,nil,4] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec5",3,true,2,[4,1],500,"default",nil,nil,5] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec6",3,true,2,[4,1],500,"default",nil,nil,6] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec7",3,true,2,[4,1],500,"default",nil,nil,7] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec8",3,true,2,[4,1],500,"default",nil,nil,8] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec9",3,true,2,[4,1],500,"default",nil,nil,9] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";
nul = ["sec10",3,true,2,[4,1],500,"default",nil,nil,10] execVM "\x\addons\Sector_addon\scripts\LV\fillHouse.sqf";

//Millitarize  // Fills area with units.
nul = ["sec11",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,11] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec12",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,12] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec13",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,13] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec14",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,14] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec15",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,15] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec16",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,16] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec17",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,17] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
nul = ["sec18",3,800,[true,false],[false,false,false],false,[4,1],[3,0],"default",nil,nil,18] execVM "\x\addons\Sector_addon\scripts\LV\militarize.sqf";
